...
const data = [
    {
        ...
        description: `#NoSponsors features a forum where off-Road enthusiasts can collaborate on their vehicle builds it 
    ...
    },
    {
        ...
        description: `Collaborative drawing app built with my Teammate Jared Baur.
...

    {
        ...
        description: `Site built with React for the FrontEnd as well as Nodejs and expressjs for the backend. The site displays information about the company in a user friendly UI. It features a contact form enforced by Google's Re-Captcha to prevent spam emails to the admin.`
    }
]
