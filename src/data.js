...
const data = [
...

    {
        ...
        description: `Site built with React for the FrontEnd as well as Nodejs and expressjs for the backend. The site displays information about the company in a user friendly UI. It also features a contact form enforced by Google's Re-Captcha to prevent spam emails to the admin.`
    }
]
